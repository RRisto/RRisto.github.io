...
Laeme andmed sisse (andmed on siin: https://github.com/RRisto/RRisto.github.io/blob/master/r/data/introductory_state_example.csv, vajuta nuppu "Raw" ja siis ctrl+s ning salvesta fail, kasuta allalaadimiseksk chrome'i või firefoxi brauserit):
```{r}
