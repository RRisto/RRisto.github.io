...
(states.csv is on siin: https://github.com/RRisto/RRisto.github.io/blob/master/r/data/states.csv, vajuta nuppu "Raw" ja seejärale ctrl+s ning salvesta fail)
```{r}
#eeldab, et andmed on data kaustas
